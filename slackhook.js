      ...
      if(pokeStopName[stop.pokestop_id] != null){
        if(inStop[stop.pokestop_id] == null) {
          ...
          if(stop.active_pokemon_id != null) {
            sendNoti("Wild " + a.pokemonlist[stop.active_pokemon_id-1].name+" Appears! "+a.pokemonlist[stop.active_pokemon_id-1].img)
          }
          ...
          if(stop.active_pokemon_id != inStop[stop.pokestop_id].active_pokemon_id) {
            if(stop.active_pokemon_id != null) sendNoti("Wild " + a.pokemonlist[stop.active_pokemon_id-1].name+" Appears! " +a.pokemonlist[stop.active_pokemon_id-1].img)
          }
          inStop[stop.pokestop_id] = stop
        }
      }
...
function updateWild(msg){
  if(inMap[msg.SpawnPointId] == null ){
    sendNoti("Wild " + a.pokemonlist[msg.PokedexTypeId-1].name+" Appears! "+a.pokemonlist[msg.PokedexTypeId-1].img)
